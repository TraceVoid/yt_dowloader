...
main.attributes("-transaprent", "green")
main.update()

# Verifica si el sistema operativo es Windows antes de intentar usar windll
if platform.system() == 'Windows':
    hWnd = windll.user32.GetForegroundWindow()
    # Puedes agregar más lógica relacionada con Windows si es necesario
